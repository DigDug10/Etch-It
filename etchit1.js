...
function createGrid(num) {
    ...
    let a = 'auto auto';
    // markup.style.gridTemplateRows = '50px 50px 50px';
    // markup.style.gridAutoRows = "50px";
    // markup.style.gridAutoRows = "minmax(20px, 20px";
    // markup.width = "150%";
    markup.style.backgroundColor = "#c4c4c4";
    // markup.style.boxShadow = "0px 0px 3.5rem #333";
    // console.log(markup.style.backgroundColor);
    document.getElementById("grid").appendChild(markup);
}
